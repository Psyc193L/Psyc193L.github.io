...
library(tidyverse)
library(kableExtra)
kbl(data.frame("Assignment" = c("Attendance Activities",
...
kbl(data.frame("Week" = c("1", "2", "3", "4", "5"), 
                           "Monday" = c("Syllabus", "<b><u>Holiday<br>No Class</u></b>",
                                                 "Color<br>Theory",
                                                 "Advanced<br>Wrangling", "Review"),
                           "Tuesday" = c("Why use R<br>Coding Basics<br>Using R Effectively<br>Preparing For More", 
                                         "Project Intro<br>Different Geoms", 
                                         "Color Theory Problem Set<br>Data Viz Challenge", 
                                         "Summarizing<br>Problem Set", "Vignettes"),
                           "Wednesday" = c("ggplot Intro<br>Aesthetics",
                                           "Problem Set", "Control Flow", 
                                           "Text Cleaning<br>Transformation", 
                                           "Project Questions"),
                           "Thursday" = c("Aesthetics<br>Problem Set<br>Tidy Data",
                                    "Customization<br>Problem Set",
                                    "Basic Wrangling<br>Problem Set",
                                    "Wrangling Challenge", "")), 
