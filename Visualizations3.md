...
<a href="Exercise_Viz3.Rmd" download>Exercise Sheet</a>
...
Changing some of the the size, font fact (by making some bold), and color, of text in your visualization will help improve its overall legibility.
...
By default, most text in ggplot2 is left-aligned. To change the location of the text, you need to ad**just** it's **v**ertical or **h**orizontal location in the coordinate system, using `vjust` or `hjust`, respectively. When adjusting:
...
However, in certain cases, particularly if you are displaying information from another variable (e.g., indicating penguin `sex` by point shape), a legend is needed and may want to be customized.
